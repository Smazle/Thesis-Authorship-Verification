...
\begin{frame}[fragile]{Problem Statement}
    \begin{itemize}
        ...
        \item This system should is only allowed falsely accuse a minority of the students,
        while catching the majority of the cheaters.
        \item It is also to provide the teacher with usable system feedback,
            to argue their case against a student.
    \end{itemize}
\end{frame}
...
\begin{frame}[fragile]{Future Work}
    \begin{itemize}
        ...
        \item Adapt to more easily integrate with Macom's internal systems.
