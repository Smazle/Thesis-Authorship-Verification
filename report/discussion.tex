...
texts supplied to it. Looking at the performance of the two \glspl{CNN}, it
...
performance, as \glspl{RNN} would be able to learn based on the words relation to
...
Another \gls{NLP} advantage \glspl{CNN} has in this context, is the fact that
