...
Another advantage \glspl{CNN} has in with regard to \gls{NLP}, is the
...
a combination between our generalizing models and author specific \gls{NN}
...
our generalizing model to find potential ghost writing candidates. Using our
\gls{conv-char-word-NN} we could catch 32.6\% of the ghost writers on a 4\%
...
we suspect ghost written assignments.
...
ghost written. That would allow a suspicious teachers to identify the part of
...
$t$ most likely to be ghost written we split $t$ into a list of paragraphs.
