...
showed in \ref{subsec:conv_char_word_nn}, even \gls{CNN}s performed badly on the
sentence level. Ideally we would have run and RNN on the word level. We suspect
