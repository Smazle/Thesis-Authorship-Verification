...
commas and the like. It would not even be able to find such traits on the word
...
\begin{description}
    ...
    \item[$P_{exp_\lambda}$]
        ...
        The exponential dropoff weight function used the time of an
        ...
        \begin{figure}
            ...
            \includegraphics[width=0.7\textwidth]{./pictures/discussion/conv_char_nn_prediction_zoom_50.png}
        ...
        \begin{figure}
            ...
            \includegraphics[width=0.7\textwidth]{./pictures/discussion/conv_char_nn_prediction_zoom_04.png}
            \caption{Illustrate important intervals for our different
                $P_{exp_\lambda}$ prediction systems for the \gls{conv-char-NN}
        ...
        weight function in this interval is therefore a tradeoff between the
        ...
        \ref{fig:conv_char_nn_prediction_zoom_04} we see a slightly different
        ...
        $P_\mathcal{U}$ is the worst weight function so we can still conclude
        ...
        some sort of time based weight function.

    \item[$P_l$]

        The idea behind the length based weight function was that longer
    ...
    \item[$P_{lepx_{0.25}}$]
        ...
        performance of the prediction systems in question.
