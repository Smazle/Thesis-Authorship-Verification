...
% TODO by August: In the following section we have written that the random
% forest method can handle bad/useless features while the extended delta and
% SVM method cannot. We have explained here why it is that extended delta method
% cannot handle it. However we still need to explain or cite someone that
% explain the other two.
%
% * We should explain why the SVM _cannot_ handle useless features, and
% * We should explain why the random forest _can_ handle useless features.
%
% The random forest is already described in the discussion section but we should
% copy that description to here.
