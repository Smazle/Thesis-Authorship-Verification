...
Input        & \begin{tabular}[c]{@{}c@{}}Serves as the entrypoint of the network, \\ by receiving a set of texts and feeding it trough the network.\end{tabular}                                          & \textbf{Shape} - The dimensions of each sample give to the input.                                                                                                                                                                                                                                                                                            \\ \hline
Embedding          & \begin{tabular}[c]{@{}c@{}}Taking in an encoded sample, \\ it produces a dense vector representation for each different. \\ More details can be found in Section *TODO:Section Reference*\end{tabular}                                                            & \begin{tabular}[c]{@{}l@{}}\textbf{Input Dim} - Size of vocabulary.\\\textbf{Output Dim} - Size of vector used to represent embedding.\\\textbf{Input Length} Length of the input sequence, when it is constant.\end{tabular}                                                                                                                                                                                                             \\ \hline
...
Global Max Pooling & \begin{tabular}[c]{@{}c@{}}Extracts the maximum value \\ from each of the provided data\end{tabular}                                                                                        & No parameters.                                                                                                                                                                                                                                                                                                                             \\ \hline
Concatenation      & \begin{tabular}[c]{@{}c@{}}As the name suggests, this layers simply \\ concatenates the data it receives from different layers\end{tabular}                                                 & No parameters.                                                                                                                                                                                                                                                                                                                             \\ \hline
