...
We also tried the network on the prediction system validation dataset with some
surprising results. It seems like the network does not generalize very well to
authors it has not seen before. So even though it had an accuracy of over 90
percent on the validation dataset the prediction system results were not very
good.

For the 50/50 dataset the best legal configuration was $\theta = 0.0$ and a
weight of 0.0 with an accuracy of 0.5 and an accusation error of 0.0.

For the 4\% dataset the best legal configuration were $\theta = 0.0$ and a
weight of 0.0 with an accuracy of 0.96 and an accusation error of 0.0.
