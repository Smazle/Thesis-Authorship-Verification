...
For the 1000 authors in (C), and with a negative chance of 50\% 
the following results were computed.

\begin{center}
\begin{verbatim}
Extended Delta Validation Accuracy: 0.644
Extended Delta Validation Accursation Error: 0.323


SVM Validation Accuracy: 0.737
SVM Validation Accursation Error: 0.24

\end{verbatim}
\end{center}

For the data-set but a 4\% chance of a negative case,
the following results were computed.

\begin{center}
\begin{verbatim}
Extended Delta Validation Accuracy: 0.721
Extended Delta Validation Accursation Error: 0.92


SVM Validation Accuracy: 0.76
SVM Validation Accursation Error: 0.91
\end{verbatim}
\end{center}
