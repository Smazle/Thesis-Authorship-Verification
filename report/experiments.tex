...
the combined set $T_'\alpha \cup \hat{T}_\alpha$, we can train the model in
...
\begin{center}
\begin{verbatim}
Extended Delta Validation Accuracy: 
Extended Delta Validation Accursation Error: 


SVM Validation Accuracy: 0.74
SVM Validation Accursation Error: 0.4
...
SVM Validation Accuracy: 0.752
SVM Validation Accursation Error: 0.92
\end{verbatim}
\end{center}
