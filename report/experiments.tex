...
number of which dwarfs the amount in the feature selection, thus the concern for
run-time isn't that lead us away from leave one out cross validation no longer
applies. The accuracy of each parameter configuration can be seen in table
\ref{table:KNN} for \gls{KNN}, and for \gls{SVM}.
...
1  & \textbf{0.668} & 0.656 & 0.636 & 0.631 & 0.618 \\
3  & 0.656 & 0.633 & 0.614 & 0.600 & 0.592 \\
5  & 0.648 & 0.616 & 0.595 & 0.581 & 0.573 \\
7  & 0.632 & 0.594 & 0.570 & 0.561 & 0.551 \\
9  & 0.623 & 0.578 & 0.555 & 0.545 & 0.533 \\
11 & 0.601 & 0.556 & 0.535 & 0.522 & 0.512 \\
13 & 0.583 & 0.534 & 0.508 & 0.492 & 0.496 \\
15 & 0.550 & 0.508 & 0.479 & 0.467 & 0.465 \\ \hline
\end{tabular}
\end{table}
...
\begin{center}
\begin{verbatim}
Extended Delta Validation Accuracy: 0.604
