...
\begin{center}
    \begin{tabular}{|c|c|c|c|c|c|c|c|c|}
        \hline
        Split  & Prediction System & $\theta$ & TP   & TN   & FP  & FN  &
        Acc    & A-Error
        \\ \hline
        50/50  & $P_{lexp_{0.25}}$ & 0.390    & 1843 & 1482 & 517 & 156 &
        0.8316 & 0.095
        \\ \hline
        96/04  & $P_{mv}$          & 0.057    & 1999 & 8    & 74  & 0   &
        0.9644 & 0.000
        \\ \hline
    \end{tabular}
\end{center}
...
\begin{center}
    \begin{tabular}{|c|c|c|c|c|c|c|c|c|}
        ...
        Acc    & A-Error
        \\ \hline
        50/50  & $P_{lexp_{0.25}}$ & 0.033    & 1965 & 310 & 1689 & 34  &
        0.5690 & 0.099
        \\ \hline
        96/04  & $P_{lexp_{0.25}}$ & 0.002    & 1999 & 1   & 79   & 0   &
        0.9620 & 0.000
        \\ \hline
    \end{tabular}
\end{center}
...
\begin{center}
    \begin{tabular}{|c|c|c|c|c|c|c|c|c|}
        ...
        Acc    & A-Error
        \\ \hline
        50/50  & $P_{lexp_{0.25}}$ & 0.433    & 1856 & 1302 & 697 & 143 &
        0.7898 & 0.099
        \\ \hline
        96/04  & $P_{exp_{0.25}}$  & 0.127    & 1999 & 9    & 73  & 0   &
        0.9649 & 0.000
        \\ \hline
    \end{tabular}
\end{center}
...
\begin{table}[h]
    ...
    \begin{tabular}{|c|c|c|c|c|c|c|c|c|c|}
        \hline
        Split                  & Network                 & Prediction System &
        $\theta$               & TP                      & TN                &
        FP                     & FN                      & Acc               &
        A-Error
        \\ \hline
        \multirow{3}{*}{50/50} & \gls{conv-char-NN}      & $P_{lexp_{0.25}}$ &
        0.390                  & 1843                    & 1482              &
        517                    & 156                     & 0.8316            &
        0.095
        \\
        ...
        0.099
        \\ \hline
        \multirow{3}{*}{96/04} & \gls{conv-char-NN}      & $P_{mv}$          &
        0.057                  & 1999                    & 8                 &
        74                     & 0                       & 0.9644            &
        0.000
        \\
