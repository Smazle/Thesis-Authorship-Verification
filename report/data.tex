...
\begin{itemize}
    ...
    \item[- (B).]
        ...
        baseline methods, where this entire set is used as the corpus, and
        subsections of it is used feature selection and hyper parameter search.
    ...
    \item[- (I).]
        ...
        with set (J). This set is used perform the feature selection needed
        for both the SVM and the Extended Delta methods. The specifics of this
        process will be described in section \ref{subsec:baseline}.

    \item[- (J).]

        This set is used to tune the baseline methods. (J) is used to determine
        the best hyper parameters for the base line methods. This would be K and
