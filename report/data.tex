...
% TODO: Write somewhere that a problem with the dataset is that we have no
% ground truth i.e. we don't know which assignments are ghost written in the
% real world.
...
sometimes the texts extracted will just contain random characters. The final
...
each dataset contains a random set of author. We have named our datasets as
upper case characters. The different datasets we use are,
