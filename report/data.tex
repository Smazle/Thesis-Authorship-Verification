...
\begin{align}
2\frac{\left|T_\alpha\right|!}{2!(\left|T_\alpha\right|-2)!}
&= \frac{\left|T_\alpha\right|!}{(\left|T_\alpha\right| - 2)!}\\
&= (\left|T_\alpha\right| - 1) \cdot \left|T_\alpha\right|
\end{align}

The neural networks are trained on these problem instances. We generate problems in the
