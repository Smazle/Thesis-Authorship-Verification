...
We initially removed the first 200 characters of each text as the beginning
...
\begin{figure}[htb]
    ...
    \begin{minipage}{.5\linewidth}
        ...
        \subfloat[]{
            ...
            \includegraphics[scale=.5]{./pictures/data/sentence_count.png}
        }
    \end{minipage}\par\medskip
    \centering
    \subfloat[]{
        \label{subfig:character_count}
        \includegraphics[scale=.5]{./pictures/data/character_count.png}
    }
