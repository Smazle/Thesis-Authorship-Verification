...
that the word/char-embedded vectors would change during training. The point
of the multiple channels was that the network was able to extract features
from multiple linguistic layers, all describing a different stylometric
feature of text. 
