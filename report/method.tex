...
\begin{figure}[htb]
    ...
    \caption{Training and validation accuracies in the different epochs of the
        networks execution.}
...
In our last network we observed that the network very quickly overfitted
completely on the training dataset.
