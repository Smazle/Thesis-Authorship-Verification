...
lstm = Bidirectional(LSTM(100, return_sequences=True))

char_features_known = lstm(known_emb)
char_features_unknown = lstm(unknown_emb)

features_known = GlobalAveragePooling1D()(char_features_known)
features_unknown = GlobalAveragePooling1D()(char_features_unknown)

cos_distance = merge([features_known, features_unknown], mode='cos', dot_axes=1)
