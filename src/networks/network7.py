...
def model(reader):
    ...
    text_1_char_repr_8 = L.GlobalAveragePooling1D()(char_conv8(text_1_char_emb))
    text_1_char_repr_4 = L.GlobalAveragePooling1D()(char_conv4(text_1_char_emb))
    text_1_word_repr_8 = L.GlobalAveragePooling1D()(word_conv8(text_1_word_emb))

    text_2_char_repr_8 = L.GlobalAveragePooling1D()(char_conv8(text_2_char_emb))
    text_2_char_repr_4 = L.GlobalAveragePooling1D()(char_conv4(text_2_char_emb))
    text_2_word_repr_8 = L.GlobalAveragePooling1D()(word_conv8(text_2_word_emb))
